...
public class Draw3D extends JPanel {
    ...
    private float mouseDragDestX;
    private float mouseDragDestY;
        ...
        this.addMouseListener(new MouseAdapter(){
            ...
            public void mouseReleased(MouseEvent e) {
                if(LAMS.toolSelection ==1){
                    ...
                    mouseDragDestX = e.getX();
                    mouseDragDestY = e.getY();
                    refresh();
                }
            }
        });
    ...
    public void drawPoints(Graphics g){
        ...
        for(Point p:pointsRef){
                ...
                if(this.mouseDown && LAMS.toolSelection==1){
                    if(Math.abs(c1.intX-this.mouseClickX)<=5){
                       if(Math.abs(c1.intY-this.mouseClickY)<=5){
                           selectedPoints.add(p.cc);
                           VertexInformationFrame.points.add(points.get(p.cc));
                       }
                    }
                }
                if(c1.intX<=this.width && c1.intY<=this.height){
                    if(selectedPoints.contains(p.cc)){
                    ...
                    g2d.fillRect(c1.intX-this.pointSize, c1.intY-this.pointSize, this.pointSize, this.pointSize);
                }
        }
    }
